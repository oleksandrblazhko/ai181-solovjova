...
|Дані: <br /> - системні (конфігураційні файли ОС та прикладного ПЗ) <br /> - прикладні дані (файли та база даних), які є результатом роботи прикладного ПЗ| + | Несанкціоноване читання даних таблиці "Звіти" в базі даних | + |
